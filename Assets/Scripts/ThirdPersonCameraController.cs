...
public class ThirdPersonCameraController : MonoBehaviour
{
    ...
    public LayerMask collisionLayerMask; // Layers to check collision against
    ...
    void UpdateFOV()
    {
        // You can modify this based on your PlayerMovementScript's sprint state
        // For now, check if Shift is held
        targetFOV = Input.GetKey(KeyCode.LeftShift) ? sprintFOV : defaultFOV;
